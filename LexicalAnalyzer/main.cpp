...
bool isStatement(char *str)                        //check if the given substring is a keyword or not
{
    if (!strcmp(str, "if") || !strcmp(str, "else") ||  !strcmp(str, "(") ||  !strcmp(str, ")") ||
...
void parse(char* str)                        //parse the expression
{
    ...
    while (right <= len && left <= right) {
                   ...
                   || (right == len && left != right))             //check if parsed substring is a keyword or identifier or number
        {
            ...
            if (isStatement(sub) == true)
            {
                cout << " " << sub << " IS A STATEMENT\n" << endl;
            }
            ...
            {
                cout << " " << sub << " IS A VALID VARIABLE\n" << endl;
            }
            else if (validIdentifier(sub) == false
                     && isPunctuator(str[right - 1]) == false)
            {
                cout << " " << sub << " IS NOT A VALID VARIABLE\n" << endl;
            }
